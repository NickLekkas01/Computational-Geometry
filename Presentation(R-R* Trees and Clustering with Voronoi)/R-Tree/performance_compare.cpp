...
int main(void){
    ...
    RStar_Tree<Point> rstar_tree(R_STAR_MIN_ENTRIES,R_MAX_ENTRIES);
    R_Tree<Point> r_tree(R_MIN_ENTRIES,R_MAX_ENTRIES);
    ...
    for(int i = 0; i < POINTS; i++){
        ...
        rstar_tree.Insert(r,Point(points_x[i],points_y[i]));
    }
...
/*
    ...
    */
    ...
    clock_t end = clock();
    cout << "R_Tree touched " << p_touch << " pages(" << p_touch / RANGE_QUERIES << " on average)" << endl;
    cout << "R_Tree checked " << r_checked << " points.(" <<  r_checked / RANGE_QUERIES << " on average)" << endl;
    ...
    for(int i = 0; i < RANGE_QUERIES;i++){
        ...
        vector<Point> res = rstar_tree.Search(query,temp_touched);
        r_checked += res.size();
    ...
    cout << "R* Tree touched " << p_touch << " pages(" << p_touch / RANGE_QUERIES << " on average)" << endl;
    cout << "R* Tree checked " << r_checked << " points.(" <<  r_checked / RANGE_QUERIES << " on average)" << endl;
    cout << "R* Tree found " << r_points << " points" << endl;
    cout << "R* Tree took " << (float)(end - start) / CLOCKS_PER_SEC << " seconds" << endl << endl;
